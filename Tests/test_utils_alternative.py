...
from utils_alternative import States, StateGenerator, RMSGenerator, IntervalGenerator, DataGenerator
...
class TestDataGenerator(unittest.TestCase):
    ...
    def test_generate_time_series_data(self):
        ...
        self.assertListEqual(list(time_series_df.columns), ['rms', 'state', 'timestamp', 'state_change', 'group', 'rms_smoothed'])
